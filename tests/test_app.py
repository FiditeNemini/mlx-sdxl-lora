...
class TestImageEditing:
    ...
    def test_load_image_for_editing_success(self, temp_workspace, reset_workspace_state):
    ...
    def test_load_image_for_editing_invalid_index(self, temp_workspace, reset_workspace_state):
    ...
    def test_save_caption_for_image_success(self, temp_workspace, reset_workspace_state):
    ...
    def test_save_caption_for_image_invalid_index(self, temp_workspace, reset_workspace_state):
...
class TestBulkOperations:
    ...
    def test_bulk_update_captions_empty_template(self, temp_workspace, reset_workspace_state):
